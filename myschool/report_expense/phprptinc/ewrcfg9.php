...
define("EWR_PROJECT_ID", "{AF2D3546-5077-4F8E-BD17-F7DECF1AA720}", TRUE); // Project ID
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "myschool", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", '7EHl8vBCxOsSyBJl', TRUE); // Random key for encryption
