<div class="sidebar-menu">
    <header class="logo-env" >
        ...
        <div class="logo" style="">
            <a href="<?php echo base_url(); ?>">
                <img src="uploads/myschool.png"  style="max-height:60px;"/>
            </a>
        </div>
    ...
    <ul id="main-menu" class="">
       ...
       <!-- TEACHER ROUTINE-->
        <li class="<?php if ($page_name == 'teacherroutine') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>report_teacher/teacher.php">
                <i class="entypo-users"></i>
                <span><?php echo get_phrase('teacherroutine'); ?></span>
            </a>
        </li>
        <!-- PARENTS -->
         ...
         <li class="<?php if ($page_name == 'invoice') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/invoice">
                ...
                <span><?php echo get_phrase('payment'); ?></span>
                  ...
                  <!-- total incom -->
         <li class="<?php if ($page_name == 'totalincom') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>report_income/income.php">
                <i class="entypo-dot"></i>
                <span><?php echo get_phrase('totalincom'); ?></span>
            </a>
        </li> 
        <!-- totalexpense -->
         <li class="<?php if ($page_name == 'totalexpense') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>report_expense/expense.php">
                <i class="entypo-dot"></i>
                <span><?php echo get_phrase('totalexpense'); ?></span>
            </a>
        </li> 
            </ul>
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'backup_restore') echo 'active'; ?> ">
                        ...
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('backup_restore'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
