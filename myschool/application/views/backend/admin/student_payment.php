	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-9">
	                                        <select name="title" class="form-control" style="width:100%;">
		                                        <option value="مصروفات الترم الاول">مصروفات الترم الاول</option>
                                                <option value="مصروفات الترم الثاني">مصروفات الترم الثاني</option>
                                                <option value="كتب">كتب</option>
                                                <option value="اتوبيس">اتوبيس</option>
                 ...
                 <!--   <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-5 col-sm-offset-3">
                            <button type="submit" class="btn btn-info" disabled><?php echo get_phrase('add_invoice');?></button>
                        </div>
                    </div>
